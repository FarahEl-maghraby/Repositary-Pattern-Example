...
var BaseRepository = /** @class */ (function () {
    ...
    BaseRepository.prototype.update = function (id, item) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.collection.updateMany({ _id: new mongodb_1.ObjectId(id) }, {
                            $set: { name: item.name },
                            $inc: { age: item.age }
                        })];
                    case 1:
                        updateUser = _a.sent();
                        return [2 /*return*/, updateUser.modifiedCount];
                }
            });
        });
    };
    BaseRepository.prototype["delete"] = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.collection.deleteOne({ _id: new mongodb_1.ObjectId(id) })];
                    case 1:
                        user = _a.sent();
                        return [2 /*return*/, user.deletedCount];
                }
            });
        });
    };
    ...
    BaseRepository.prototype.find = function (item) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.collection.find({ age: item.age }).toArray()];
                    case 1:
                        users = _a.sent();
    ...
    BaseRepository.prototype.findOne = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.collection.findOne({ _id: new mongodb_1.ObjectId(id) })];
                    case 1:
                        user = _a.sent();
